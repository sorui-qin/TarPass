...
class StructuralCalculator:
    ...
    def calculate_all(self, mol: Mol) -> dict[str, float]:
        ...
        self.properties = {
            ...
            "bertzCT": bertzCT(mol),
            "spacial score": spacial_score(
                standard_mol(mol)
            ),  # conformation will influence the results
            # Ring properties
...
def get_torsions(mol: Mol) -> list:
    ...
    torsionList = []
    torsionSmarts = (
        "[!$(*#*)&!D1]-&!@[!$(*#*)&!D1]"  # Bond between atom 2-3 should be single bond
    )
...
def get_dihedral(mol: Mol) -> list:
    ...
    for e in G.edges():
        ...
        dihedralList.append((n0[0], e[0], e[1], n1[0]))
    return dihedralList
...
class EspSim:
    ...
    def calculate(self) -> dict[str, float]:
        ...
        return {
            ...
            "electrostatic_similarity": self.electrostatic_similarity(
                self.test, self.ref
            ),
        }
